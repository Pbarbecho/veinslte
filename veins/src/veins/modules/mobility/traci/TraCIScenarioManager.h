...
class TraCIScenarioManager : public cSimpleModule
{
	...
	protected:
		...
		std::string filename;
		std::fstream IP_File; //File to save ip of nodes
	...
	protected:
        ...
        /**
        *   for record ip addresses
        *
        */
 		void CaptureIPAddress(std::string nodeId, std::string FullName, IPv4Address idtoaddress, int macID);
